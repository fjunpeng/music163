...
Create TABLE wy_userToCollect(
    ...
    targetId    INT,
    uid         INT
    -- FOREIGN KEY(uid) REFERENCES wy_userToCollect(uid)
);
...
CREATE TABLE wy_user_PersonalDetails(
    ...
    region      VARCHAR(32),
    uid         INT
    -- FOREIGN KEY(uid) REFERENCES wy_user_PersonalDetails(uid)
);
...
INSERT INTO wy_songer VALUES(6,"周笔畅","这是歌手周笔畅",1534567,106);
...
INSERT INTO wy_special VALUES(
    1,"1st EP",,"http://127.0.0.1:7300/img/songer/1stEP.jpg",112233);
INSERT INTO wy_special VALUES(
    2,"Get Everybody Moving Concert 2011",,"http://127.0.0.1:7300/img/songer/GetEverybodyMovingConcert2011.jpg",113333);
INSERT INTO wy_special VALUES(
    3,"初学者",,"http://127.0.0.1:7300/img/songer/初学者.jpg",112244);
INSERT INTO wy_special VALUES(
    4,"Greatest Hits 新曲+精选",,"http://127.0.0.1:7300/img/songer/GreatestHits新+精选.jpg",232233);
INSERT INTO wy_special VALUES(
    5,"Love Best 最爱情歌集",,"http://127.0.0.1:7300/img/songer/LoveBest最爱情歌集(1).jpg",112433);
INSERT INTO wy_special VALUES(
    6,"My Secret",,"http://127.0.0.1:7300/img/songer/MySecret.jpg",152233);
INSERT INTO wy_special VALUES(
    7,"Unforgettable Concert 中国巡回演唱会2011",,"http://127.0.0.1:7300/img/songer/UnforgettableConcert中国巡回演唱会2011.jpg",112633);
INSERT INTO wy_special VALUES(
    8,"光年之外",,"http://127.0.0.1:7300/img/songer/光年之外.jpg",112263);
INSERT INTO wy_special VALUES(
    9,"那么喜欢你",,"http://127.0.0.1:7300/img/songer/那么喜欢你.jpg",115233);
INSERT INTO wy_special VALUES(
    10,"你过得好吗",,"http://127.0.0.1:7300/img/songer/你过得好吗",112833);
INSERT INTO wy_special VALUES(
    11,"朋友",,"http://127.0.0.1:7300/img/songer/朋友.jpg",112433);
INSERT INTO wy_special VALUES(
    12,"七里香",,"http://127.0.0.1:7300/img/songer/七里香.jpg",192233);
INSERT INTO wy_special VALUES(
    13,"未完成的歌",,"http://127.0.0.1:7300/img/songer/未完成的歌.jpg",112433);
INSERT INTO wy_special VALUES(
    14,"薛之谦",,"http://127.0.0.1:7300/img/songer/薛之谦.jpg",112733);
INSERT INTO wy_special VALUES(
    15,"中国新歌声 第二季 第1期",,"http://127.0.0.1:7300/img/songer/中国新歌声第二季第1期.jpg",112233);
INSERT INTO wy_special VALUES(
    16,"周杰伦的床边故事",,"http://127.0.0.1:7300/img/songer/周杰伦的床边故事.jpg",112263);
    */
...
INSERT INTO wy_songList VALUES("1stEP",`"",""`,2500,1,1112233);
